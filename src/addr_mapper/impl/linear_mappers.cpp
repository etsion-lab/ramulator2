...
class RoBaRaChCo final : public LinearMapperBase, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IAddrMapper, RoBaRaChCo, "RoBaRaChCo", "Applies a RoBaRaChCo mapping to the address.");
