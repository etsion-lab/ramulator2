...
class DDR5_EK : public IDRAM, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IDRAM, DDR5_EK, "DDR5-ek", "DDR5_EK Device Model")
  private:
    int m_RH_radius = -1;

    // Stats for row open durations and average time between openings
    size_t s_total_row_open_duration = 0;
    size_t s_total_time_btwn_row_reopens = 0;
    size_t s_total_row_reopen_count = 0;
    float s_avg_row_open_duration = 0.0f;
    ...
    // Map to track the last open cycle for each row: channel -> rank -> bank -> row -> last open cycle
    std::map<int, std::map<int, std::map<int, std::map<int, int>>>> row_last_open_cycle;

    // Map to track the total time between openings for each row: channel -> rank -> bank -> row -> total time
  ...
  public:
    ...
    inline static const std::map<std::string, std::vector<int>> timing_presets = {
      ...
      // Yoav
      {"DDR5_5600AN",  {5600,  8,  40,  40,   40,    90,  130,   84,   21,  38,  6,    8,     8,     38+8+7,    14,     28,    38+8+28,   8,   -1,   -1,  -1,   -1,   -1,    -1,     53,    -1,   -1,   -1,     -1,     -1,    2,   357}},
      {"DDR5_5600BN",  {5600,  8,  46,  46,   46,    90,  136,   84,   21,  46,  6,    8,     8,     46+8+7,    14,     28,    46+8+28,   8,   -1,   -1,  -1,   -1,   -1,    -1,     53,    -1,   -1,   -1,     -1,     -1,    2,   357}},
      {"DDR5_5600C",   {5600,  8,  50,  49,   49,    90,  139,   84,   21,  48,  6,    8,     8,     48+8+7,    14,     28,    48+8+28,   8,   -1,   -1,  -1,   -1,   -1,    -1,     53,    -1,   -1,   -1,     -1,     -1,    2,   357}},

      {"DDR5_8000AN",  {8000,  8,  56,  56,   56,   128,  184,  120,   30,  54,  4,    8,     8,     54+8+8,    20,     40,    54+8+40,   8,   -1,   -1,  -1,   -1,   -1,    -1,     75,    -1,   -1,   -1,     -1,     -1,    2,   250}},
      {"DDR5_8000BN",  {8000,  8,  64,  56,   64,   128,  184,  120,   30,  62,  4,    8,     8,     62+8+8,    20,     40,    62+8+40,   8,   -1,   -1,  -1,   -1,   -1,    -1,     75,    -1,   -1,   -1,     -1,     -1,    2,   250}},
      {"DDR5_8000C",   {8000,  8,  70,  56,   70,   128,  184,  120,   30,  68,  4,    8,     8,     68+8+8,    20,     40,    68+8+40,   8,   -1,   -1,  -1,   -1,   -1,    -1,     75,    -1,   -1,   -1,     -1,     -1,    2,   250}},
    };
  ...
  public:
    struct Node : public DRAMNodeBase<DDR5_EK> {
      Node(DDR5_EK* dram, Node* parent, int level, int id) : DRAMNodeBase<DDR5_EK>(dram, parent, level, id) {};
    };
    ...
    double s_total_refresh_energy = 0.0;
  ...
  public:
    ...
    void init() override {
      ...
      // Register stats for row operations
      register_stat(s_total_row_open_duration).name("total_row_open_duration");
      // register_stat(s_total_time_btwn_row_reopens).name("total_row_reopen_time");
      // register_stat(s_total_row_reopen_count).name("total_row_reopen_count");
    ...
    void issue_command(int command, const AddrVec_t& addr_vec) override {
      ...
      int rank_id = addr_vec[m_levels["rank"]];
      int bank_id = addr_vec[m_levels["bank"]];
      int row_id = addr_vec[m_levels["row"]];

      // Update timing, power, and state
            ...
            for (const auto& [rank, banks] : ranks) {
                ...
                for (const auto& [bank, rows] : banks) {
                    for (const auto& [row, total_duration] : rows) {
                        ...
                        int total_time_between_opens = row_total_time_between_opens[channel][rank][bank][row];
  ...
  private:
    ...
    void set_actions() {
      ...
      // Rank Actions
      m_actions[m_levels["rank"]][m_commands["PREA"]] = Lambdas::Action::Rank::PREab<DDR5_EK>;
      m_actions[m_levels["rank"]][m_commands["REFab"]] = Lambdas::Action::Rank::REFab<DDR5_EK>;
      m_actions[m_levels["rank"]][m_commands["REFab_end"]] = Lambdas::Action::Rank::REFab_end<DDR5_EK>;
      m_actions[m_levels["rank"]][m_commands["RFMab"]] = Lambdas::Action::Rank::REFab<DDR5_EK>;
      m_actions[m_levels["rank"]][m_commands["RFMab_end"]] = Lambdas::Action::Rank::REFab_end<DDR5_EK>;
      m_actions[m_levels["rank"]][m_commands["DRFMab"]] = Lambdas::Action::Rank::REFab<DDR5_EK>;
      m_actions[m_levels["rank"]][m_commands["DRFMab_end"]] = Lambdas::Action::Rank::REFab_end<DDR5_EK>;
      
      // Same-Bank Actions.
      m_actions[m_levels["bankgroup"]][m_commands["PREsb"]] = Lambdas::Action::BankGroup::PREsb<DDR5_EK>;

      // We call update_timing for the banks in other BGs here
      m_actions[m_levels["bankgroup"]][m_commands["REFsb"]]  = Lambdas::Action::BankGroup::REFsb<DDR5_EK>;
      m_actions[m_levels["bankgroup"]][m_commands["REFsb_end"]]  = Lambdas::Action::BankGroup::REFsb_end<DDR5_EK>;
      m_actions[m_levels["bankgroup"]][m_commands["RFMsb"]]  = Lambdas::Action::BankGroup::REFsb<DDR5_EK>;
      m_actions[m_levels["bankgroup"]][m_commands["RFMsb_end"]]  = Lambdas::Action::BankGroup::REFsb_end<DDR5_EK>;
      m_actions[m_levels["bankgroup"]][m_commands["DRFMsb"]] = Lambdas::Action::BankGroup::REFsb<DDR5_EK>;
      m_actions[m_levels["bankgroup"]][m_commands["DRFMsb_end"]] = Lambdas::Action::BankGroup::REFsb_end<DDR5_EK>;

      // Bank actions
      m_actions[m_levels["bank"]][m_commands["ACT"]] = Lambdas::Action::Bank::ACT<DDR5_EK>;
      m_actions[m_levels["bank"]][m_commands["PRE"]] = Lambdas::Action::Bank::PRE<DDR5_EK>;
      m_actions[m_levels["bank"]][m_commands["RDA"]] = Lambdas::Action::Bank::PRE<DDR5_EK>;
      m_actions[m_levels["bank"]][m_commands["WRA"]] = Lambdas::Action::Bank::PRE<DDR5_EK>;
    };
    ...
    void set_preqs() {
      ...
      // Rank Preqs
      m_preqs[m_levels["rank"]][m_commands["REFab"]]  = Lambdas::Preq::Rank::RequireAllBanksClosed<DDR5_EK>;
      m_preqs[m_levels["rank"]][m_commands["RFMab"]]  = Lambdas::Preq::Rank::RequireAllBanksClosed<DDR5_EK>;
      m_preqs[m_levels["rank"]][m_commands["DRFMab"]] = Lambdas::Preq::Rank::RequireAllBanksClosed<DDR5_EK>;

      // Same-Bank Preqs.
      m_preqs[m_levels["rank"]][m_commands["REFsb"]]  = Lambdas::Preq::Rank::RequireSameBanksClosed<DDR5_EK>;
      m_preqs[m_levels["rank"]][m_commands["RFMsb"]]  = Lambdas::Preq::Rank::RequireSameBanksClosed<DDR5_EK>;
      m_preqs[m_levels["rank"]][m_commands["DRFMsb"]] = Lambdas::Preq::Rank::RequireSameBanksClosed<DDR5_EK>;

      // Bank Preqs
      m_preqs[m_levels["bank"]][m_commands["RD"]] = Lambdas::Preq::Bank::RequireRowOpen<DDR5_EK>;
      m_preqs[m_levels["bank"]][m_commands["WR"]] = Lambdas::Preq::Bank::RequireRowOpen<DDR5_EK>;
      m_preqs[m_levels["bank"]][m_commands["ACT"]] = Lambdas::Preq::Bank::RequireRowOpen<DDR5_EK>;
      m_preqs[m_levels["bank"]][m_commands["PRE"]] = Lambdas::Preq::Bank::RequireBankClosed<DDR5_EK>;
    };

    void set_rowhits() {
      m_rowhits.resize(m_levels.size(), std::vector<RowhitFunc_t<Node>>(m_commands.size()));

      m_rowhits[m_levels["bank"]][m_commands["RD"]] = Lambdas::RowHit::Bank::RDWR<DDR5_EK>;
      m_rowhits[m_levels["bank"]][m_commands["WR"]] = Lambdas::RowHit::Bank::RDWR<DDR5_EK>;
    }
    ...
    void set_rowopens() {
      ...
      m_rowopens[m_levels["bank"]][m_commands["RD"]] = Lambdas::RowOpen::Bank::RDWR<DDR5_EK>;
      m_rowopens[m_levels["bank"]][m_commands["WR"]] = Lambdas::RowOpen::Bank::RDWR<DDR5_EK>;
    }
    ...
    void set_powers() {
      ...
      m_powers[m_levels["bank"]][m_commands["ACT"]] = Lambdas::Power::Bank::ACT<DDR5_EK>;
      m_powers[m_levels["bank"]][m_commands["PRE"]] = Lambdas::Power::Bank::PRE<DDR5_EK>;
      m_powers[m_levels["bank"]][m_commands["RD"]]  = Lambdas::Power::Bank::RD<DDR5_EK>;
      m_powers[m_levels["bank"]][m_commands["WR"]]  = Lambdas::Power::Bank::WR<DDR5_EK>;

      // m_powers[m_levels["rank"]][m_commands["REFsb"]] = Lambdas::Power::Rank::REFsb<DDR5_EK>;
      // m_powers[m_levels["rank"]][m_commands["REFsb_end"]] = Lambdas::Power::Rank::REFsb_end<DDR5_EK>;
      m_powers[m_levels["rank"]][m_commands["RFMsb"]] = Lambdas::Power::Rank::RFMsb<DDR5_EK>;
      m_powers[m_levels["rank"]][m_commands["RFMsb_end"]] = Lambdas::Power::Rank::RFMsb_end<DDR5_EK>;
      // m_powers[m_levels["rank"]][m_commands["DRFMsb"]] = Lambdas::Power::Rank::REFsb<DDR5_EK>;
      // m_powers[m_levels["rank"]][m_commands["DRFMsb_end"]] = Lambdas::Power::Rank::REFsb_end<DDR5_EK>;

      m_powers[m_levels["rank"]][m_commands["ACT"]] = Lambdas::Power::Rank::ACT<DDR5_EK>;
      m_powers[m_levels["rank"]][m_commands["PRE"]] = Lambdas::Power::Rank::PRE<DDR5_EK>;
      m_powers[m_levels["rank"]][m_commands["PREA"]] = Lambdas::Power::Rank::PREA<DDR5_EK>;
      m_powers[m_levels["rank"]][m_commands["REFab"]] = Lambdas::Power::Rank::REFab<DDR5_EK>;
      m_powers[m_levels["rank"]][m_commands["REFab_end"]] = Lambdas::Power::Rank::REFab_end<DDR5_EK>;
      // m_powers[m_levels["rank"]][m_commands["RFMab"]] = Lambdas::Power::Rank::REFab<DDR5_EK>;
      // m_powers[m_levels["rank"]][m_commands["RFMab_end"]] = Lambdas::Power::Rank::REFab_end<DDR5_EK>;
      // m_powers[m_levels["rank"]][m_commands["DRFMab"]] = Lambdas::Power::Rank::REFab<DDR5_EK>;
      // m_powers[m_levels["rank"]][m_commands["DRFMab_end"]] = Lambdas::Power::Rank::REFab_end<DDR5_EK>;

      m_powers[m_levels["rank"]][m_commands["PREsb"]] = Lambdas::Power::Rank::PREsb<DDR5_EK>;
      ...
      for (auto& power_stat : m_power_stats){
        ...
        register_stat(power_stat.total_refresh_energy).name("total_refresh_energy_rank{}", power_stat.rank_id);
    ...
    void finalize() override {
      ...
      //row open duration and re-open calculation
      if (s_total_row_reopen_count > 0) {
        s_avg_time_between_row_opens = static_cast<float>(s_total_time_btwn_row_reopens) / s_total_row_reopen_count;
      }
    ...
    void process_rank_energy(PowerStats& rank_stats, Node* rank_node) {
      ...
      Lambdas::Power::Rank::finalize_rank<DDR5_EK>(rank_node, 0, AddrVec_t(), m_clk);
      ...
      rank_stats.total_refresh_energy = ref_cmd_energy;
