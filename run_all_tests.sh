#!/bin/bash
# Single Core
perl /scratch/elior.k/ramulator2/scripts/run_ek.pl --name collect_metrics_SC_data-analytics-core --config /scratch/elior.k/ramulator2/example_config_ek.yaml --bench data-analytics-core-1
...
perl /scratch/elior.k/ramulator2/scripts/run_ek.pl --name collect_metrics_SC_data-serving-core --config /scratch/elior.k/ramulator2/example_config_ek.yaml --bench data-serving-core-1
...
perl /scratch/elior.k/ramulator2/scripts/run_ek.pl --name collect_metrics_MC_data-serving-core --config /scratch/elior.k/ramulator2/example_config_ek.yaml --bench data-serving-core-8
